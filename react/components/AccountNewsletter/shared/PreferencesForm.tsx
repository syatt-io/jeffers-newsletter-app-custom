...
const PreferencesForm = ({handleChange, fields}:any) => {
  ...
  return(
      ...
      <div className={handles.form__preferences}>
        ...
        <DisclosureLayout key={fields.petInterest} initialVisibility={fields.petInterest ? 'visible' : 'hidden'}>
          <DisclosureTrigger>
        ...
        <div className={handles.form__container}>
          <DisclosureLayout key={fields.equineInterest} initialVisibility={fields.equineInterest ? 'visible' : 'hidden'}>
            <DisclosureTrigger>
              <div className={handles.form__itemHeading}>
                <div className={handles.form__inputContainer}>
        ...
        <div className={handles.form__container}>
        <DisclosureLayout key={fields.livestockInterest} initialVisibility={fields.livestockInterest ? 'visible' : 'hidden'}>
          <DisclosureTrigger>
              <div className={handles.form__itemHeading}>
                <div className={handles.form__inputContainer}>
